...
* [4 响应式系统](#4-响应式系统)
  * [4.1 基本实现](#41-基本实现)
  * [4.2 完善响应式系统](#42-完善响应式系统)
  * [4.3 分支切换](#43-分支切换)
  * [4.4 嵌套的effect与effect栈](#44-嵌套的effect与effect栈)
  * [4.5 避免无限递归循环](#45-避免无限递归循环)
  * [4.6 调度执行](#46-调度执行)
* [5 js对象与proxy的工作原理](#5-js对象与proxy的工作原理)
  * [5.1 直接使用target[key]会有问题](#51-直接使用targetkey会有问题)
  * [5.2 使用Reflect](#52-使用reflect)
<!-- TOC -->
# 4 响应式系统
